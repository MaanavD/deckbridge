...
SOURCE_LOGO = {
    ...
    "claude-desktop": "claude-code.svg",
    "codex-cli": "codex-cli.svg",
    "codex-desktop": "codex-cli.svg",
    "codex": "codex-cli.svg",
    "cursor-agent": "cursor-agent.svg",
    "cursor-desktop": "cursor-agent.svg",
    "t3code": "t3code.svg",
    "t3code-claude": "claude-code.svg",
    "t3code-codex": "codex-cli.svg",
    "t3code-cursor": "cursor-agent.svg",
    "t3code-grok": "t3code.svg",
    "t3code-opencode": "t3code.svg",
    "herdr": "herdr.svg",
    "cmux": "cmux.svg",
    "mic": "mic.svg",
    "slack": "slack.svg",
